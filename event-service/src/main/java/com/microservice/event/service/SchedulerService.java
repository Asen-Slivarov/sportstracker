...
public class SchedulerService {
    ...
    public SchedulerService(StatsServiceClient statsClient, MessagePublisher publisher, MessageMapper mapper) {
        this.statsClient = statsClient; this.publisher = publisher; this.mapper = mapper;
    }
    public void pollAndPublish(String eventId) {
        ...
        } catch (Exception e) { log.error("Error polling stats for {}", eventId, e); }
    }
}
